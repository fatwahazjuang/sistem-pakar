...
$numrows = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM gejala where nama_gejala = '$nama_gejala'"));
			if ($numrows > 0){
				echo "<script>alert('Nama Gejala Sudah Pernah Di Input !'); window.location='../../gejala/tambahgejala'</script>";
      }else{
