...
<html><head>
    ...
    <base href="http://localhost/sistem-pakar/">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b></i>KS</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Kusta</b></span>
        </a>
        <!-- Header Navbar -->
      ...
      <footer class="main-footer">
        <strong><div class="cinta">Copyright © 2022</div></strong>
      </footer>
